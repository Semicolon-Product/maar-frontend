...
const Login = () => {
  ...
  const [superAdminSignupFormData, setSuperAdminSignUpFormData] =
    useState<SuperAdminSignupFormData>({
      name: "",
      email: "",
      password: "",
      collegeName: "",
  ...
  const handleStudentLogInSubmit = async (e: any) => {
    ...
    if (!studentData.roll.trim())
      errors.roll = "University Roll No is required";
  ...
  const handleSuperAdminSignupSubmit = async (e: any) => {
    ...
    if (!superAdminSignupFormData.email.trim())
      errors.email = "Email is required";
    if (!superAdminSignupFormData.password.trim())
      errors.password = "Password is required";
    if (!superAdminSignupFormData.collegeName.trim())
      errors.collegeName = "Institute name is required";
    if (!superAdminSignupFormData.collegeCode.trim())
      errors.collegeCode = "Institute code is required";
    setFormError(errors);
    ...
    const payload = {
      ...
      password: superAdminSignupFormData.password,
      college_code: superAdminSignupFormData.collegeCode,
      college_name: superAdminSignupFormData.collegeName,
    };
  ...
  const handleSuperAdminLoginSubmit = async (e: any) => {
    ...
    if (!superAdminLoginForm.password.trim())
      errors.password = "Password is required";
    setFormError(errors);
    if (Object.keys(errors).length > 0) return;
  ...
  return (
    <div
      className={`flex ${role === "student" ? "bg-yellow-100/50" : ""} 
    ${role === "teacher" ? "bg-green-100/50" : ""} 
    ${role === "superadmin" ? "bg-red-100/50" : ""}
    ...
    >
      ...
      <div
        className={`w-full  max-w-3xl ${getGradientByRole(
          role
        )} border border-gray-400 rounded-2xl  shadow p-4 sm:p-6 grid md:grid-cols-2 gap-4`}
      >
        <form className="flex flex-col gap-6">
          ...
          {role === "student" && (
            <>
              <div>
                ...
                <input
                  ...
                  className={`w-full border ${
                    formError?.roll ? "border-red-600" : "border-gray-300"
                  } rounded px-3 py-2 `}
                />
                {formError?.roll && (
                  <p className="text-red-600 text-sm">{formError?.roll}</p>
                )}
              </div>
              <div>
                ...
                <div className="relative w-full">
                  <input
                    ...
                    className={`w-full border ${
                      formError?.password ? "border-red-600" : "border-gray-300"
                    } rounded px-3 py-2`}
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="bg-yellow-600 text-white py-2 rounded cursor-pointer"
              >
                Login
              </button>
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className={`w-full border ${
                    formError?.email ? "border-red-600" : "border-gray-300"
                  } rounded px-3 py-2`}
                />
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className={`w-full border ${
                    formError?.name ? "border-red-600" : "border-gray-300"
                  } rounded px-3 py-2`}
                />
                {formError?.name && (
              ...
              <button
                onClick={handleSuperAdminSignupSubmit}
          ...
          {role === "superadmin" && superadminLogin && (
            <>
              ...
              <button
                onClick={handleSuperAdminLoginSubmit}
