...
import { initialStudentActivityFormData, type StudentActivityFormData, type YearlyActivityList } from "../types/superadminType";
...
const StudentYearlyDetails = ({ data }) => {
    ...
    useEffect(() => {
        ...
        currentTotalPoints = formData.moocs12Weeks + formData.moocs8Weeks
    ...
    const handleSubmit = (e: any) => {
        e.preventDefault();
        if (formData.moocs12Weeks + formData.moocs8Weeks + formData.moocs4Weeks + formData.moocs2Weeks > 40)
            toast.error("Moocs can't be greater than 40")
            ...
            <form onSubmit={handleSubmit}>
                <table className="table-auto border border-black w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr className={` ${data[1].subpoints[0].max == data[1].subpoints[0].already_acquired
                            ...
                            <td className="border  border-black px-2 py-1">
                                ...
                                <select
                                    ...
                                    disabled={data[1].subpoints[0].max == data[1].subpoints[0].already_acquired}
                                >
                                    <option value="0">-- Select --</option>
