    ...
    return (
        <div>
            <div className="flex gap-36">
                <p className="mainHeading">Activity Points</p>
                <p className="mainHeading">Pointsper Activity</p>
                <p className="mainHeading">Permissible Points(max)</p>
            ...
            <div>
                <div>
                    <h3 className="text-[1em] font-semibold mb-2 formHeading">1. MOOCS (SWAYAM/NPTEL/Spoken Tutorial etc.)</h3>
                    <div className="space-y-2 flex flex-col ml-5">

                        <label htmlFor="">a. 12 weeks / 40 Hours</label>
                        <input type="number"
